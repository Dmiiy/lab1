...
{
    res->data=realloc(res->data,(l1->size+l2->size + 1) * l1->typeInfo->elementSize);
    ...
    // сделать через риаллок создать общий буфер куда скопировать
    // void *tempResult1 = malloc(l1->typeInfo->elementSize);
    // if (tempResult1 == NULL)
    // {
    ...
    // {
    //     const void *elem1 = (const char *)l1->data + i * l1->typeInfo->elementSize;
    //     l1->typeInfo->mergeElements(tempResult1,elem1);
    //     linePushBack(res, tempResult1);
    // }
    // free(tempResult1);
    // void *tempResult2 = malloc(l2->typeInfo->elementSize);
    // if (tempResult2 == NULL)
    // {
    //     printf("memory allocation error");
    //     return;
    ...
    // {
    //     const void *elem2 = (const char *)l2->data + i * l2->typeInfo->elementSize;
    //     l2->typeInfo->mergeElements(tempResult2,elem2);
    //     linePushBack(res, tempResult2);
    // }
    // free(tempResult2);
...
void lineSubline (Line *res,const Line *l,const int i,const int j)
{
    ...
    // if (l->typeInfo->elementSize == NULL)
    // {
    //     printf("memory allocation error");
    //     return;
    // }
    ...
    {
        const void *elem = (const char *)l->data + k * l->typeInfo->elementSize;
        //l->typeInfo->subElement(tempResult,elem);
        linePushBack(res, elem);
    }
    //free(tempResult);
